$(function () {
    $(".num .sub").click(function () {
        ...
        if (c <= 1) {
            ...
            // 购物车商品数量减一，同步购物车数据库信息减一
            if( $(this).siblings("span").attr('datasrc')) {
                var url = "cartshopnumsadd?count="+c+"&pid="+$(this).siblings("span").attr('datasrc');
                $.get(url, function(){});
            }
    ...
    $(".del").click(function () {
        if ($(this).parent().parent().hasClass("th")) {
            ...
            // 购物车删除，同步删除购物车数据库信息
            var url = "cartshopdel?pid="+$(this).attr('datasrc');
